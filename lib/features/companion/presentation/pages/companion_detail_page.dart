          ...
          Positioned.fill(
            child: Padding(
              ...
              child: BlocBuilder<CompanionActionsCubit, CompanionActionsState>(
                builder: (context, actionsState) {
                  final isInteracting = actionsState is CompanionActionsLoading;
                  final currentAction = actionsState is CompanionActionsLoading
                      ? actionsState.action
                      : null;

                  debugPrint(
                      '🎭 [DETAIL] Pasando a AnimationWidget: isInteracting=$isInteracting, action=$currentAction');
  ...
  Widget _buildFloatingActions(BuildContext context,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          // 🔥 Botón Alimentar CORREGIDO - Validación relajada (90 en lugar de 95)
          _buildActionButton(
            icon: Icons.restaurant,
            color: Colors.green,
            onPressed: (currentCompanion.hunger < 90) &&
                    !isLoading // ✅ CAMBIAR DE 95 A 90
                ? () {
                    debugPrint(
            ...
            disabled:
                currentCompanion.hunger >= 90, // ✅ CAMBIAR VALIDACIÓN A 90
            label: 'Alimentar',
          ),

          // 🔥 Botón Dar Amor CORREGIDO - Validación relajada (90 en lugar de 95)
          _buildActionButton(
            icon: Icons.favorite,
            color: Colors.pink,
            onPressed: (currentCompanion.happiness < 90) &&
                    !isLoading // ✅ CAMBIAR DE 95 A 90
                ? () {
                    debugPrint(
            ...
            disabled:
                currentCompanion.happiness >= 90, // ✅ CAMBIAR VALIDACIÓN A 90
            label: 'Amor',
          ),
