// lib/features/news/presentation/pages/news_main_page.dart - RESTAURADO CON DRAWER
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            // 🔧 TEXTO CORTO para evitar overflow
            const Expanded(
              child: Text(
                'Noticias',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Xico selecciona las noticias más relevantes para mantenerte informado.',
